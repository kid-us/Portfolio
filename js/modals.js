...
const phoneHomeBtn = document.getElementById("close-contact-modal");
...
// ########### Small
// Small device contact modal
const smContactModal = document.getElementById("sm-contact-modal");
const smContactBtn = document.getElementById("sm-contact-btn");

// small contact
const smallContactBtn = document.getElementById("sm-contact-btn");
if (smallContactBtn)
  smallContactBtn.addEventListener("click", () => {
    contactModal.classList.remove("hidden");
    document.getElementById("body").style.overflow = "hidden";
  });
